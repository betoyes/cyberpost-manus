    ...
    <DashboardLayout>
      <div className="mx-auto w-full max-w-6xl space-y-8">
        ...
        <div className="cc-signal relative overflow-hidden rounded-2xl border bg-gradient-to-br from-card via-card to-primary/5 p-8">
          <div
            className="cc-grid pointer-events-none absolute inset-0 opacity-50"
            aria-hidden
          />
          <div
          ...
          <div className="relative">
            ...
            <p className="mt-2 max-w-xl text-sm text-muted-foreground">
              Gerencie o calendário, acompanhe o status de cada publicação e
              mantenha o fluxo de postagens no Instagram sob controle — com
              aprovação por e-mail e checagem automática diária.
            </p>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <HealthRow
                label="Google (Drive/Sheets/Gmail)"
                ok={flags?.googleConnected}
              />
              <HealthRow
                label="Instagram (Meta Graph)"
                ok={flags?.metaConnected}
              />
              <HealthRow
                label="Planilha configurada"
                ok={flags?.sheetConfigured}
              />
              <HealthRow
                label="Checagem diária ativa"
                ok={flags?.cronEnabled}
              />
              <Button
                variant="outline"
