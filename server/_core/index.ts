...
import { bridgePostHandler, bridgeStatusHandler, bridgeAccountsHandler, bridgeHostVideoHandler } from "../bridgeApi";
...
async function startServer() {
  ...
  app.post("/api/bridge/host-video", bridgeHostVideoHandler);
